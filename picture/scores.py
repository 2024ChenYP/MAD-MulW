import pandas as pd
data1 = pd.read_csv('saveTCN.csv')
TCN = data1.loc[:, ['TCN']].values.T.reshape(-1).tolist()
data2 = pd.read_csv('saveAE.csv')
AE = data2.loc[:, ['AE']].values.T.reshape(-1).tolist()
...
x_data = range(len(TCN))
y_data_flow_amount = TCN
y_data_rain_fall_amount = AE
(
    Line(init_opts=opts.InitOpts(width="900px", height="300px"))
    ...
    .set_global_opts(
        title_opts=opts.TitleOpts(title="Model components", # subtitle="TCN & AE"
                                  pos_left="center", pos_top="top",
                                  title_textstyle_opts=opts.TextStyleOpts(font_size=30, font_family="Times New Roman"),# subtitle_textstyle_opts=opts.TextStyleOpts(font_size=20)
                                  ),
        ...
        yaxis_opts=opts.AxisOpts(name="TCN", type_="value", max_=15,
                                 axislabel_opts=opts.LabelOpts(font_size=20, font_family="Times New Roman"),
                                 name_textstyle_opts=opts.TextStyleOpts(font_size=20, font_family="Times New Roman")),
    )
    .set_series_opts(
        ...
        # label_opts=opts.LabelOpts(position='right', font_size = 16),
    )
    .render("rainfall.html")
)
# make_snapshot(snapshot, Line.render, "measure_threshold.jpg")