...
df_train = pd.read_csv(f'../data/Coffee/Coffee_TRAIN.tsv', sep='\t', header=None)  # 读取完整包含标签的BGP数据集（地址）
df_test = pd.read_csv(f'../data/Coffee/Coffee_TEST.tsv', sep='\t', header=None)  # 读取完整包含标签的BGP数据集（地址）
