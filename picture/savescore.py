...
"""
import pandas as pd
data1 = pd.read_csv('savescore.csv')
all_data = data1.loc[:, ['score']].values.T.reshape(-1).tolist()
...
(
    ...
    .add_xaxis(xaxis_data=range(0, len(all_data)))
    .add_yaxis(
        series_name="",
        y_axis=all_data,
        yaxis_index=0,
    ...
    .set_global_opts(
        title_opts=opts.TitleOpts(title="Score"),
        ...
        visualmap_opts=opts.VisualMapOpts(
            ...
            is_piecewise=True,
            pieces=[
                {"gt": 0, "lte": 109, "color": "#70ad46"},
                {"gt": 109, "lte": 500, "color": "#4272c5"},
